...
class MessiahDecoderTest : public ::testing::Test {
 protected:
...
TEST_F(MessiahDecoderTest, ExtraVertexOBJ) {
  const std::string file_name = "extra_vertex.obj";
  test_decoding(file_name);
}

TEST_F(MessiahDecoderTest, PartialAttributesOBJ) {
  const std::string file_name = "cube_att_partial.obj";
  test_decoding(file_name);
}

TEST_F(MessiahDecoderTest, SubObjects) {
...
TEST_F(MessiahDecoderTest, SubObjectsWithMetadata) {
  // Tests loading an Obj with sub objects.
  const std::string file_name = "cube_att_sub_o.obj";
...
TEST_F(MessiahDecoderTest, QuadTriangulateOBJ) {
...
TEST_F(MessiahDecoderTest, QuadPreserveOBJ) {
...
TEST_F(MessiahDecoderTest, OctagonTriangulatedOBJ) {
...
TEST_F(MessiahDecoderTest, OctagonPreservedOBJ) {
...
TEST_F(MessiahDecoderTest, EmptyNameOBJ) {
...
TEST_F(MessiahDecoderTest, PointCloudOBJ) {
...
TEST_F(MessiahDecoderTest, WrongAttributeMapping) {
...
TEST_F(MessiahDecoderTest, TestObjDecodingAll) {
