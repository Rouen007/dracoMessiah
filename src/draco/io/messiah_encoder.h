...
class MessiahEncoder {
 ...
 private:
  ...
  const PointAttribute *color_att_;
  const PointAttribute *tex1_coord_att_;
  const PointAttribute *tex2_coord_att_;
  const PointAttribute *tangent_att_;
  const PointAttribute *binormal_att_;
  const PointAttribute *weight_att_;
  const PointAttribute *indices_att_;
  const PointAttribute *indices_name_att_;
